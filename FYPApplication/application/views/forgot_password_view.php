            ...
            <div class="login-logo" >
                <b><u style="font-size:30px;">OM Furnishing Management System</u><b>
                        ...
                        <div class="login-box-body">
                            ...
                            <form action="<?=base_url('forgot_password/send_code')?>" method="post">
                                <div class="form-group has-feedback">
                                    <input type="email" name="email" class="form-control" placeholder="Enter Email to send code" value="<?=$this->input->get('email')?>" autofocus required>
